...
export const CHAT_MODELS: ChatModel[] = [
  ...
  },
  {
    ...
    description: MODEL_CONFIGS.GEMINI.description,
    apiKey: MODEL_CONFIGS.GEMINI.apiKey,
    supportsImages: MODEL_CONFIGS.GEMINI.supportsImages,
  },
  {
    ...
    description: MODEL_CONFIGS.LLAMA.description,
    apiKey: MODEL_CONFIGS.LLAMA.apiKey,
    supportsImages: MODEL_CONFIGS.LLAMA.supportsImages,
  },
