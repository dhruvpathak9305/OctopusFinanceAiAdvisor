...
const MobileDateFilter: React.FC = () => {
  ...
  const handleCustomDateChange = (event: any, selectedDate: Date | undefined, type: 'start' | 'end') => {
  ...
  const renderDateRangeItem = (range: DateRange) => (
    ...
    >
      <View style={styles.rangeContent}>
        <View style={[styles.rangeIcon, { backgroundColor: `${range.color}20` }]}>
        ...
        {selectedRange === range.id && (
          <View style={[styles.selectedIndicator, { backgroundColor: range.color }]}>
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.text }]}>Quick Ranges</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={[
            ...
            {
              backgroundColor: colors.card,
              borderColor: selectedRange === 'custom' ? colors.primary : colors.border,
      ...
      {showStartPicker && (
        <DateTimePicker
          ...
          onChange={(event, date) => handleCustomDateChange(event, date, 'start')}
