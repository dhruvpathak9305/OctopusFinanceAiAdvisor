    ...
    },
    {
      ...
      assets: [
        ...
        },
        {
          id: "3b",
          name: "Embassy REIT",
          category: "REITs & Real Estate Funds",
          value: 130000,
          percentage: 3,
          icon: "business",
          color: "#F59E0B",
  ...
  if (selectedCategory) {
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        {/* Category Summary */}
        <View
          style={[styles.categorySummary, { backgroundColor: colors.card }]}
        >
          <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryRight}>
              <Text
                style={[styles.summaryValue, { color: selectedCategory.color }]}
              >
        ...
        <ScrollView style={styles.assetDetails}>
          {selectedCategory.assets.map((asset) => (
            <View key={asset.id}>{renderAssetDetail({ item: asset })}</View>
          ))}
        </ScrollView>
      ...
      <View style={[styles.netWorthCard, { backgroundColor: colors.card }]}>
        ...
        <View style={styles.assetsLiabilities}>
          <View style={styles.assetLiabilityItem}>
            <Text style={[styles.alLabel, { color: colors.textSecondary }]}>
              Total Assets
            </Text>
            <Text style={[styles.alValue, { color: colors.primary }]}>
              ₹1.1Cr
            </Text>
          </View>
          <View style={styles.assetLiabilityItem}>
