  ...
  const renderCreditCard = ({ item }: { item: CreditCard }) => (
    <View style={[styles.cardContainer, { backgroundColor: colors.card }]}>
      ...
      <View style={styles.cardHeader}>
        ...
        <TouchableOpacity>
          <Text style={[styles.manageCard, { color: colors.textSecondary }]}>Manage card</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.limitSection}>
        <Text style={[styles.limitLabel, { color: colors.text }]}>Limit used</Text>
          ...
          <View 
            style={[
              ...
              { 
                ...
                width: `${getUsagePercentage(item.limitUsed, item.totalLimit)}%` 
              }
            ]} 
          />
        </View>
      ...
      <TouchableOpacity style={[styles.viewBreakdownButton, { backgroundColor: colors.background, borderColor: colors.border }]}>
        <Text style={[styles.viewBreakdownText, { color: colors.text }]}>View breakdown</Text>
      </TouchableOpacity>
    </View>
  );
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.cardsHeader}>
          <View>
            <Text style={[styles.cardsTitle, { color: colors.text }]}>All cards</Text>
            <Text style={[styles.cardsSubtitle, { color: colors.textSecondary }]}>
