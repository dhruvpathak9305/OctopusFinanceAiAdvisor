...
const RecentTransactionsSection: React.FC<RecentTransactionsSectionProps> = ({
  ...
  const TransactionItem: React.FC<{ transaction: Transaction }> = ({
    ...
    // Import fallback icon utilities and database-driven icon functions
    const {
    ...
    const getTransactionIcon = () => {
      ...
      // Priority 3: Use transaction icon as text/emoji
    ...
    return (
      <TouchableOpacity style={styles.transactionItem} activeOpacity={0.8}>
        <View style={styles.transactionLeft}>
          ...
          >
            {(() => {
              const iconResult = getTransactionIcon();

              // If it's a React component (Lucide icon), render it directly
              ...
              return (
                <Text style={styles.transactionIconText}>{iconResult}</Text>
              );
            })()}
          </View>
