 ...
 */
export const getTableName = (baseTableName: string, isDemo: boolean): string => {
...
export const validateTableConsistency = (tableMap: TableMap): boolean => {
  ...
  if (hasReal && hasDemo) {
    console.error('Table mapping inconsistency detected! Mixing demo and real tables:', tableMap);
    return false;
  }
